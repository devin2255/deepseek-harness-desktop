...
Source: [`packages/host/webserver/src/index.ts:48`](../packages/host/webserver/src/index.ts)
...
- `@deepseek-ai/dsh-desktop-app` — requires `webServer` ([`packages/bundle/desktop-app/src/index.ts`](../packages/bundle/desktop-app/src/index.ts))
