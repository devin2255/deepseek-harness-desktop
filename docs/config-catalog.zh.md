...
来源：[`packages/host/webserver/src/index.ts:48`](../packages/host/webserver/src/index.ts)
...
- `@deepseek-ai/dsh-desktop-app` — 需要 `webServer`（[`packages/bundle/desktop-app/src/index.ts`](../packages/bundle/desktop-app/src/index.ts)）
