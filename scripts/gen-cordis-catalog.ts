...
export const EVENT_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  'layout/navigate': 'client-face explicit center navigation signal — packages/client/ui-layout/README.md owns the API',
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  AssignTaskWorktreeRequest: 'task.md',
  ApplyTaskReviewRequest: 'task.md',
  CommitTaskReviewRequest: 'task.md',
  DiscardTaskReviewRequest: 'task.md',
  DefineTaskRequest: 'task.md',
  GetTaskFileDiffRequest: 'task.md',
  RecordTaskApplyRequest: 'task.md',
  RecordTaskCommitRequest: 'task.md',
  RecordTaskDiscardRequest: 'task.md',
  RecordTaskRiskRequest: 'task.md',
  ReviewTaskRequest: 'task.md',
  TaskListChange: 'task.md',
  TaskListSnapshot: 'task.md',
  LiveTaskFact: 'task.md',
  SummarizeTaskReviewRequest: 'task.md',
  TaskApplyReceipt: 'task.md',
  TaskCommitReceipt: 'task.md',
  TaskDiscardReceipt: 'task.md',
  TaskFileDiff: 'task.md',
  TaskReviewSummary: 'task.md',
  TaskSnapshot: 'task.md',
  CreateTaskWorktreeRequest: 'task.md',
  TaskWorktreeAssignment: 'task.md',
  TaskWorktreeAvailability: 'task.md',
