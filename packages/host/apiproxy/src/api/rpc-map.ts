...
export interface RpcMethodMap {
  ...
  'task.reviewSummary': TasksApi['reviewSummary']
  'task.reviewDiff': TasksApi['reviewDiff']
  'task.commit': TasksApi['commit']
  'task.apply': TasksApi['apply']
  'task.discard': TasksApi['discard']
